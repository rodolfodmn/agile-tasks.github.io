export const allLayers = [
	{
		...
		secondary:
			[
				...
				{src: `B_2`, pos: {top: '0', left: '50', delay: 30}}
			]
	},
	{
		bg: 'bg-psico',
		...
		secondary:
			[
				...
				{src: `C_3`, pos: {top: '100', left: '50', delay: 30}}
			]
	},
	{
		bg: 'bg-timezone',
		...
		secondary:
			[
				...
				{src: `A_2`, pos: {top: '100', left: '50', delay: 30}}
			]
	},
	{
		bg: 'bg-code',
		...
		secondary:
			[
				...
				{src: `D_2`, pos: {top: '100', left: '50', delay: 30}}
			]
	},
	{
		bg: 'bg-cto',
		...
		text:
			[
				...
				{
					text: 'CTO', class: `cto2`, pos: {top: '292', left: '-350', delay: 20}
				}
			],
		secondary:
			[
				{src: `F_3`, pos: {top: '44', left: '40', delay: 30}},
				{src: `F_2`, pos: {top: '0', left: '0', delay: 30}}
			]
	},
	{
		bg: 'bg-gatlin',
...
export const allLayersMobile = [
	{
		bg: 'bg-remoto',
		central: {
			src: `centralwoo`, pos: {top: '45', left: '50', delay: 10}
		},
		text:
			[
				{text: `Comunicação Assíncrona & `, class: `remoto1`, pos: {top: '187', left: '-160', delay: 20}},
				{text: ` Trabalho Remoto`, class: `remoto2`, pos: {top: '437', left: '-160', delay: 20}}
			],
		secondary:
			[
				{src: `B_3`, pos: {top: '190', left: '50', delay: 30}},
				{src: `B_2`, pos: {top: '0', left: '50', delay: 30}}
			]
	},
	{
		bg: 'bg-psico',
		central: {
			src: `centralbrain`, pos: {top: '90', left: '50', delay: 10}
		},
		text:
			[
				{text: `Segurança`, class: `psico1`, pos: {top: '70', left: '-120', delay: 20}},
				{text: `Psicológica`, class: `psico2`, pos: {top: '116', left: '-120', delay: 20}}
			],
		secondary:
			[
				{src: `C_2`, pos: {top: '90', left: '50', delay: 30}},
				{src: `C_3`, pos: {top: '90', left: '0', delay: 30}}
			]
	},
	{
		bg: 'bg-timezone',
		central: {
			src: `A_1`, pos: {top: '46', left: '0', delay: 10}
		},
		text:
			[
				{text: `Fazendo as \npazes \ncom `, pre: true, class: `timezone1`, pos: {top: '136', left: '-114', delay: 20}},
				{text: `timezone`, class: `timezone2`, pos: {top: '550', left: '-133', delay: 20}}
			],
		secondary:
			[
				{src: `A_3`, pos: {top: '90', left: '0', delay: 30}},
				{src: `Saly`, pos: {top: '90', left: '50', delay: 30}}
			]
	},
	{
		bg: 'bg-code',
		central: {
			src: `centralbook`, pos: {top: '240', left: '40', delay: 10}
		},
		text:
			[
				{text: `Introdução à Infraestrutura como`, class: `code1`, pos: {top: '80', left: '-150', delay: 20}},
				{text: `Código`, class: `code2`, pos: {top: '295', left: '-36', delay: 20}}
			],
		secondary:
			[
				{src: `D_3`, pos: {top: '100', left: '50', delay: 30}},
	...
	},
	{
		bg: 'bg-cto',
		central: {
			src: `centralphone`, pos: {top: '209', left: '00', delay: 10}
		},
		text:
			[
				{
				...
				{
					text: 'CTO', class: `cto2`, pos: {top: '192', left: '-150', delay: 20}
				}
			],
		secondary:
			[
				{src: `F_3`, pos: {top: '0', left: '40', delay: 30}},
				{src: `F_2`, pos: {top: '0', left: '0', delay: 30}}
			]
	},
	{
		bg: 'bg-gatlin',
		central: {
			src: `centraldon`, pos: {top: '0', left: '22', delay: 10}
		},
		text:
			[
				{text: `Testes de carga com Gatlin`, class: `gatlin1`, pos: {top: '80', left: '-150', delay: 20}},
			],
		secondary:
			[
				{src: `E_3`, pos: {top: '100', left: '50', delay: 30}},
